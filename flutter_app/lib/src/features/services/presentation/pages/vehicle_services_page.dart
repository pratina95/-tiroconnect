...
class VehicleServicesPage extends StatefulWidget {
  const VehicleServicesPage({super.key});

  @override
  State<VehicleServicesPage> createState() => _VehicleServicesPageState();
}

class _VehicleServicesPageState extends State<VehicleServicesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Vehicle Services'),
        centerTitle: true,
          ...
          child: Column(
            ...
            children: [
              ...
              CustomTextField(
                ...
                label: 'Description',
                hint: 'Describe your vehicle needs',
                maxLines: 4,
